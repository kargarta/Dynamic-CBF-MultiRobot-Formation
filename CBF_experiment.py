...
gamma_f_rec    = 50   # recovery formation CBF gain
...
# cost weights
p_clf          = 200.0
p_form_base    = 6.0    # base formation cost weight
p_form_rec     = 40.0   # recovery formation cost weight
p_obs          = 80.0
p_clf2         = 30.0
...
for center, size, vel in [([ 0.6,-0.7], [0.2,0.1], [-0.000, 0.040]), ([ 0.7,0.7], [0.2,0.1], [-0.000, -0.035])]:
